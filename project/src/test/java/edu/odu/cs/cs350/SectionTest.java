...
public class SectionTest {
    ...
    @Before
    public void setUp() {
        section = new Section("12345", "fall", "main", 30, 25, "A1");
    }
    ...
    public void testGetXlstGroup() {
        assertEquals(30, section.getXlstGroup());
    }
    ...
    public void testEnrollStudentFailure() {
        section = new Section("12345", "fall", "main", 25, 25, "A1");
    ...
    public void testHashCode() {
        Section sameSection = new Section("12345", "fall", "main", 30, 25, "A1");
    ...
    public void testEquals() {
        Section sameSection = new Section("12345", "fall", "main", 30, 25, "A1");
        Section differentSection = new Section("54321", "spring", "main", 30, 25, "B1");
